 ...
 <table style = "border: 0px">
  <tr  style = "display: flex">
   <td width = 50% style = "float:left; align:center; ">
    ...
    <p> Until there, you have to install R version 4.2.2 (https://cran.r-project.org/bin/windows/base/old/4.2.2/) installed in your computer.</p>
    <p> Install RStudio (https://posit.co/downloads/ and set <strong>R4.2.2</strong>strong> as the default version (tools/global options/ R general/ R version) -> C:\Program Files\R\R-4.2.2)</p>
